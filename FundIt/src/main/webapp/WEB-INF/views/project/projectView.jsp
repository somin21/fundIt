...
span.sp{font-size: 15px; font-weight: bold;}
span.sp2{font-size: 14px;}

div.menuDiv{text-align: left; padding: 5px 0 5px 18%;}
div.mainContext{width: 700px;border: 1px solid;display: inline-block;}
div.communityDiv{width: 700px;border: 1px solid;display: inline-block;}
div.changeDiv{width: 700px;border: 1px solid;display: inline-block;}

div.originator{width: 270px;border: 1px solid;display: inline-block; text-align: left;padding: 10px;}
#originatorStory{font-weight: bold;}
img.originatorImg{border-radius: 100%; width: 30px; height: 30px;}
.originContext{word-break:break-all; border: 1px solid; width: 250px;}
...
<hr />
	...
	<c:forEach var="i" items="${list }">
            ...
            <div class="goal">
                ...
                <div class="notice">
               	...
               	<c:if test="${i.deadlineDay le 0 } && ${i.supportGoal le i.supportMoney } ">
                	<span class="sp">펀딩 성공!</span> <br><br>
                ...
                <c:if test="${i.deadlineDay le 0 } && ${i.supportGoal gt i.supportMoney }">
                	<span class="sp">펀딩 실패!</span> <br><br>
                ...
                <c:if test="${i.deadlineDay gt 0}" > 
                    <span class="sp">펀딩 진행중</span> <br><br>
        ...
        <div class="originator">
            <span id="originatorStory">창작자 소개</span><br><br>
            <div>
                <img src="img/전주.jpg" alt="" class="originatorImg">
                <span>창작자ID</span>
                <p class="originContext">qkdjksjdklasjdklasjdlkasjdljasdjlkasjdlasjlkdjlajglkalkgalkghlaksdlkahlgkajkgajlgkjasldjlaksd</p>
