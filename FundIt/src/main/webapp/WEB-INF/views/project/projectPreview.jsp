    ...
    <div class="mainDIV">
        ...
        <div class="mainTitle">
            ...
            <div class="goal">
                ...
                <button class="button" style="vertical-align:middle" onclick="fn_projectConfirm();"><span>검토요청</span></button>
                <button class="button2 button4" style="vertical-align:middle" onclick="fn_projectUpdate();">
                	<img src="${pageContext.request.contextPath }/resources/images/makeProject/write.png" style="height:22px;width:25px;"/>
                	<span>&nbsp;<b>수정</b></span>
                </button>
                
                <form id="projectButtonForm" name="projectButtonForm" action="" method="post">
                	<input type="hidden" name="projectNo" value="${view.projectNo }" />
                </form>
                <script>
                function fn_projectConfirm(){
                	$("#projectButtonForm").attr("action","${pageContext.request.contextPath}/project/confirm");
                	$("#projectButtonForm").submit();
                }
                function fn_projectUpdate(){
                	$("#projectButtonForm").attr("action","${pageContext.request.contextPath}/project/updateProject/outline");
                	$("#projectButtonForm").submit();
                }
                </script>
